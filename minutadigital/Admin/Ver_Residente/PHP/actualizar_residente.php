...
if ($result !== false && $result->num_rows > 0) {
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/minutadigital/Admin/Ver_Residente/CSS/actualizar_residente.css" />
        <title>Actualizar Residente</title>
    </head>
    <body>
        <div class="contenedor">
            <a href="/minutadigital/Admin/Ver_Residente/PHP/ver_residente.php"><img class="img_admin_home" src="/minutadigital/Admin/Ver_Residente/IMG/imagenMinuta.jpg" /></a>
