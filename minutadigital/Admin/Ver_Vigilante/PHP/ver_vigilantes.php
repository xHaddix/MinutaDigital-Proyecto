...
function eliminarRegistro($cedula) {
    ...
    // Agrega la lógica para eliminar el registro en la base de datos aquí
...
// Consulta SQL para obtener todos los vigilantes
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/minutadigital/Admin/Ver_Vigilante/CSS/admin_vigilantes.css" />
    <title>Ver Vigilantes</title>
    <script src="/minutadigital/Admin/Ver_Vigilante/JS/recargar_pagina.js" defer></script>
    <script>
        ...
        function actualizarRegistro(cedula) {
            ...
            window.location.href = "actualizar_vigilante.php?cedula=" + cedula;
        }
    </script>
</head>
<body>
    <div class="contenedor">
        <a href="/minutadigital/Admin/admin_home/HTML/admin_home.html">
            <img class="img_admin_home" src="/minutadigital/Admin/Ver_Vigilante/IMG/imagenMinuta.jpg" />
        </a>
    ...
    <div>
        <h2 class="listado_usuarios">Listado de Vigilantes:</h2>
        <h2 class="admin">Administrador</h2>
    </div>

    <a href="/minutadigital/Admin/AdminCrearVigilante/HTML/Admin_crear_vigilantes.html">
        <button class="crearVigilanteBTN">Crear Vigilante</button>
    </a>
    ...
    <table>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='9'>No hay vigilantes registrados</td></tr>";
            }
            ?>
        </tbody>
    </table>
