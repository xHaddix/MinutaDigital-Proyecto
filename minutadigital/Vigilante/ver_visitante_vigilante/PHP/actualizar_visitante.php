...
if ($result !== false && $result->num_rows > 0) {
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/minutadigital/Vigilante/ver_visitante_vigilante/CSS/actualizar_visitante.css" />
        <title>Actualizar Visitante</title>
    </head>
    <body>
        <div class="contenedor">
            <a href="/minutadigital/Vigilante/ver_visitante_vigilante/PHP/ver_visitante.php"><img class="img_admin_home" src="/minutadigital/Vigilante/ver_visitante_vigilante/IMG/imagenMinuta.jpg" /></a>
